...
export default function MoviesPage() {
  const { isLoading, isError } = useMovies()
  ...
  if (isError) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#08090b] text-white">
        No pudimos cargar la información del catálogo.
      </main>
    )
  }
    ...
    <main className="min-h-screen bg-[#08090b] px-6 py-14 text-white">
      <section className="mx-auto max-w-6xl">
        <div className="mb-10 text-center">
          ...
          <h1 className="text-5xl font-black">Catálogo de Películas</h1>

          <p className="mx-auto mt-4 max-w-2xl leading-8 text-zinc-400">
            Descubre los estrenos más esperados, los clásicos que marcaron
            generaciones y las películas más populares del momento. Encuentra tu
            próxima función y vive una experiencia única en la pantalla grande.
          </p>
        </div>
